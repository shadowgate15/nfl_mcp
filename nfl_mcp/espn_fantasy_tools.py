...
`get_espn_league` and `get_espn_transactions` are built on this foundation;
later tickets add the rest of the catalog (rosters, standings, matchups,
draft, free agents) as siblings in this module.
"""
